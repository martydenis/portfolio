<footer id="footer" >
    <div class="container-fluid <?php echo $route['name'] !== 'contact' ? 'd-flex flex-column full-height' : '' ?>">
        ...
        <p class="flex-grow d-flex flex-column justify-center align-center">
            <a class="footer_contact_link font-serif h1 fs-huge text-hover-effect animate mb-0" href="/contact" data-anim-type="letters">Let's get in touch</a>
        ...
        <div id="footer__content" class="d-flex">
            <a href="#" class="js-sroll-to-top btn-circle absolute-center">
                <svg class="icon">
